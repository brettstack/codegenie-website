...
const testimonialsData = [
  {
    ...
    content:
      "The powerful analytic tools have helped us streamline our processes and make data-driven decisions that positively impact our efficiency. Code Genie has been a game-changer for our business. The platform is easy to use, and the insights we've gained have driven significant improvements.",
    image: testimonial1,
  },
  {
    customerName: 'John Watkins',
    ...
    <div className="flex flex-col w-full lg:w-[1150px] justify-center">
      ...
      >
        ...
        <div className="custom-block-big-title text-center mb-16 px-8 sm:px-24 md:px-48">
          People like you love Code Genie
        </div>
