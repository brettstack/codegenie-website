---
title: 'Create AWS Cognito User Pool Resources with CDK'
date: 2024-02-31
excerpt: how to
authors:
  - brett
...
We'll use [CDK](https://docs.aws.amazon.com/cdk/v2/guide/home.html) to create our Cognito User Pool and related AWS resources.
...
:::note
[Scroll up](#create-cognito-user-pool-resources-with-cdk) to see the other code tabs
:::
