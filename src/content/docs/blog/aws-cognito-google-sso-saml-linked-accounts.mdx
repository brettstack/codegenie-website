...
## Create Cognito User Pool Resources with CDK
...
1. <a href='https://console.cloud.google.com/apis/credentials/oauthclient?' target="_blank" rel="noopener">Create OAuth client ID</a>:
    ...
    1. Click "Add URI" under "Authorised redirect URIs". Copy the same value from above, but this time add "/oauth2/idpresponse" to the end. Add another URI here for "http://localhost:3001" if you want to enable Google signin during local development.
    1. Click Save
