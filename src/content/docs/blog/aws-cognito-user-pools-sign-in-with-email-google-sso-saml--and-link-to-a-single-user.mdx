---
title: 'AWS Cognito User Pools: Sign in with Email, Google, or SSO (SAML) and link to a single user'
date: 2024-02-29
...
[Cognito User Pools](https://aws.amazon.com/cognito/) is an AWS service that provides user identity and auth to applications. This series of articles cover a full stack solution enabling users to sign in with Email + Password, Google Sign In, and SSO/SAML, and link them all to the same user within the app.
