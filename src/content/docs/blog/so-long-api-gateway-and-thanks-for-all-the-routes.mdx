...
API Gateway <a href="https://aws.amazon.com/about-aws/whats-new/2024/06/amazon-api-gateway-integration-timeout-limit-29-seconds/" target="_blank" rel="noopener">recently announced</a> it can increase the max timeout via support request. This is only available for Regional REST APIs (not the less-expensive HTTP API offering, or Edge-Optimized REST APIs). Additionally, this increase comes at the cost of a decrease for the account-level throttle quota limits.
:::
...
You can try it out yourself at <a href="https://production.d1gtqqp4ixg5qm.amplifyapp.com/public-api" target="_blank" rel="noopener">https://production.d1gtqqp4ixg5qm.amplifyapp.com/public-api</a> (no guarantees on how long this website will be live) or deploy your own version by cloning this repo <a href="https://github.com/brettstack/cloudfront-apigw-lambda" target="_blank" rel="noopener">https://github.com/brettstack/cloudfront-apigw-lambda</a> and running `npm run init:dev`
