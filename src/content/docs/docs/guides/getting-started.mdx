...
:::tip
If you don't yet have an account, you can create one during this flow. If you choose to signup with an Email + Password, you'll receive an email with a confirmation code. You'll need to enter the code on the same tab you used to register to complete the CLI login. If you instead clicked the link, simply re-run `npx @codegenie/cli login`.
:::
