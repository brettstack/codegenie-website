...
`_app.tsx` is the main entry point of your application and is responsible for initializing Auth, HTTP Client, Theme, React Query, and Global Layout. It also checks whether the user is currently logged in and either shows the requested page or the login page. Read more on the [Next.js Custom App guide](https://nextjs.org/docs/pages/building-your-application/routing/custom-app).
